...
function AboutHero({ headerRef, headerY, headerOp }: AboutHeroProps) {
  return (
    <section ref={headerRef as React.RefObject<HTMLElement>} className="relative min-h-[85vh] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10 pb-16 w-full">
        ...
        <m.div style={{ y: headerY, opacity: headerOp }}>
...
function FoundingStory({ storyRef, photoY }: FoundingStoryProps) {
  return (
    <section ref={storyRef as React.RefObject<HTMLElement>} className="mx-auto max-w-7xl px-6 md:px-10 py-24">
...
interface MissionSectionProps {
  ...
  dividerScaleY: MotionValue<number>;
}

function MissionSection({ missionRef, dividerScaleY }: MissionSectionProps) {
  return (
    <section ref={missionRef as React.RefObject<HTMLElement>} className="relative border-y border-white/[0.05] overflow-hidden">
...
export default function AboutPage() {
  ...
  return (
    ...
    <>
      <AboutHero headerRef={headerRef} headerY={headerY} headerOp={headerOp} />

      <FoundingStory storyRef={storyRef} photoY={photoY} />
      ...
      <MissionSection missionRef={missionRef} dividerScaleY={dividerScaleY} />
