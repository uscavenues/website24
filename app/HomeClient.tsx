...
import { LazyMotion, domAnimation, m, useScroll, useTransform, useMotionValue, MotionValue } from "framer-motion";
    ...
    <>
      ...
      <div ref={heroRef} className="relative h-[320vh]">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <m.div className="absolute inset-0 bg-black pointer-events-none" style={{ opacity: blackOp, zIndex: 5 }} />
          ...
          >
            <Image src="/assets/icons/avenues-logo.png" alt="Avenues logo" fill sizes="(max-width: 768px) 88vw, 1500px" className="object-contain invert" priority />
          </m.div>
            ...
            <div className="relative mx-auto max-w-7xl px-6 md:px-10 w-full flex-1 flex flex-col justify-center pt-16">
              ...
              <h1 className="text-[clamp(4rem,12vw,10rem)] font-black leading-[0.88] tracking-tighter text-white" aria-label="Avenues Consulting Group">
                ...
                <span className="inline-flex items-center" style={{ gap: 0 }}>
                  ...
                  <m.span className="inline-block" style={{ opacity: venuesOp, x: venuesX }}>
                    VENUES
                  </m.span>
                </span>
                ...
                <m.span className="inline-block" style={{ opacity: consultOp, y: consultY }}>
                  <span className="text-[#eb4c60]">CONSULTING</span>
                </m.span>

                <br />

                <m.span className="inline-block" style={{ opacity: groupOp, y: groupY }}>
                  GROUP
                </m.span>
              </h1>
