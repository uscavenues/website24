        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-12 md:gap-20">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500 leading-relaxed max-w-[260px]">
              USC&apos;s premier student-run consulting group. Pro-bono strategy,
              technology, and design for organizations that matter.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="w-8 h-8 flex items-center justify-center border border-white/[0.08] rounded-sm text-zinc-500 hover:text-[#eb4c60] hover:border-[#eb4c60]/30 transition-all duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/apply" className="text-sm text-zinc-500 hover:text-white transition-colors duration-200">
                  Apply to Join
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-sm text-zinc-500 hover:text-white transition-colors duration-200">
                  Partner With Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <span className="text-sm text-zinc-600">Los Angeles, CA</span>
              </li>
            </ul>
          </div>
        </div>
